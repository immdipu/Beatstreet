...
export const PlayerProvider = ({ children }) => {
  ...
  const SearchAll = async (text) => {
    ...
    try {
      const res = await axios.get(`${BASEURL}/search/all?query=${text}`);
  ...
  const SearchSongs = async (keyword) => {
    ...
    try {
      const res = await axios.get(
        `${BASEURL}/search/songs?query=${keyword}}&page=1`
      );
  ...
  const SearchAlbums = async (keyword) => {
    ...
    try {
      const res = await axios.get(
        `${BASEURL}/search/albums?query=${keyword}}&page=1`
      );
  ...
  const PageChange = async (text, page) => {
    try {
      const res = await axios.get(
        `${BASEURL}/search/songs?query=${text}&page=${page}`
      );
      const result = res.data.data.results;
  ...
  const AlbumsPageChange = async (text, page) => {
    try {
      const res = await axios.get(
        `${BASEURL}/search/albums?query=${text}&page=${page}`
      );
      const result = res.data.data.results;
